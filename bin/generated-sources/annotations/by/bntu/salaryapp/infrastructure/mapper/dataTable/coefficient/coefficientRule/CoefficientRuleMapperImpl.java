...
public class CoefficientRuleMapperImpl implements CoefficientRuleMapper {
    ...
    public CoefficientRuleDto toDto(CoefficientRule entity) {
        ...
        coefficientRuleDto.setCreatedBy( entityCreatedById( entity ) );
        coefficientRuleDto.setUpdatedBy( entityUpdatedById( entity ) );
        ...
        coefficientRuleDto.setUpdatedAt( entity.getUpdatedAt() );
    ...
    private UUID entityCreatedById(CoefficientRule coefficientRule) {
        User createdBy = coefficientRule.getCreatedBy();
        if ( createdBy == null ) {
            return null;
        }
    ...
    private UUID entityUpdatedById(CoefficientRule coefficientRule) {
        User updatedBy = coefficientRule.getUpdatedBy();
        if ( updatedBy == null ) {
            return null;
        }
