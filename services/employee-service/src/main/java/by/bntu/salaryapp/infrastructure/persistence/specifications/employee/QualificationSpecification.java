...
public record QualificationSpecification(QualificationFilterDto filter) implements Specification<Qualification> {
    @Override
    public Predicate toPredicate(@NonNull Root<Qualification> root,
                                 CriteriaQuery<?> query,
